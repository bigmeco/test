...
CREATE TABLE `tovar` (
  ...
  `colijestvo` int(11) DEFAULT NULL,
  PRIMARY KEY (`idtovar`)
...
INSERT INTO `tovar` VALUES (6,'тыква',700,54),(7,'сгущёнка',69,4),(8,'арбуз',180,35),(9,'ананас',350,5),(10,'сок',79,73);
...
-- Dump completed on 2017-04-19 19:50:03
