...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mConnectionStateT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mConnectionStateT = (TextView) findViewById(R.id.connection_state);
...
// результатом чтения или операцией уведомления
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                System.out.println(mBluetoothLeService.getSupportedGattServices());
    ...
    private void updateConnectionState(final int resourceId) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                mConnectionStateT.setText(resourceId);
            }
        });
    }
}
